...
async function handle(req,res) {
  ...
  if(u.pathname==='/api/fonts/status'&&req.method==='GET'){if(fontApplyState.busy&&Date.now()-fontApplyState.startedAt>10*60*1000)fontApplyState={busy:false,startedAt:0};return json(res,200,fontApplyState)}
