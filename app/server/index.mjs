...
const appVersion = '0.6.1.2.pre.20';
...
async function handle(req,res) {
  ...
  if(u.pathname==='/api/fonts/status'&&req.method==='GET'){if(fontApplyState.busy){const age=Date.now()-fontApplyState.startedAt;if((age>30000&&await probeOnlyOffice())||age>2*60*1000)fontApplyState={busy:false,startedAt:0}}return json(res,200,fontApplyState)}
